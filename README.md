...
Скрипт генерирует эталонные изображения испанских заглавных букв (включая `Ñ`), вычисляет по ним признаки из варианта лабораторной №5 и сохраняет результаты в удобных папках/файлах. Алфавит сверен со справочными источниками (например, https://www.slavcorpora.ru), а внешний вид символов базируется на системных шрифтах.
